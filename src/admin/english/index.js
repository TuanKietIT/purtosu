...
import ModelCreate from './component/create'
import ModelEdit from './component/edit'
                ...
                <div className="new-users">
                    <div className='container-category-admin'>
                        ...
                        <div className='user-admin-create'>
                           <button onClick={handleCreate}><PlusOutlined /> Thêm mới</button>
                        </div>
                    </div>
                </div>
                               ...
                               {action && (
                                <div className='list-english-sub-action'>
                                    <div className='list-english-sub'>
                                        <button className="bnt-edit_supplier" onClick={handleClickEdit} type="button" >
